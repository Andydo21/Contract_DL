# Generated by Django 5.2.15 on 2026-06-21 17:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='ACTIVE', max_length=50, verbose_name='Status')),
                ('network', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nodes', to='blockchain.blockchainnetwork', verbose_name='Blockchain Network')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('network', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='blockchain.blockchainnetwork', verbose_name='Blockchain Network')),
                ('proof', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='blockchain.hashproof', verbose_name='Hash Proof')),
            ],
            options={
