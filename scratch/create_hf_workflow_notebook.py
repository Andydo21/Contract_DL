...
# Uses d90nqm/contract-workflow (DebertaV2ForSequenceClassification)
# directly from Hugging Face to:
#   1. Classify contract -> WF_TYPE  (8 classes)
#   2. Map WF_TYPE -> ordered steps + role_id (from STEP_MATRIX)
    ...
    "cells": [
        {
            ...
            "source": [
                ...
                "\n",
                "Notebook này load model **[d90nqm/contract-workflow](https://huggingface.co/d90nqm/contract-workflow)** "
                "(DebertaV2ForSequenceClassification, 8 classes) trực tiếp từ Hugging Face Hub.\n\n",
                "## Luồng xử lý\n",
