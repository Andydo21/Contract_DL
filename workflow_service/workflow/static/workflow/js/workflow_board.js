            ...
            <div class="wf-card status-${w.status}">
                <div class="wf-card-header">
                    <div class="wf-name" title="${w.workflow_name}">
                        <a href="/board/${w.workflow_id}/" style="color: inherit; text-decoration: none; transition: var(--transition);" onmouseover="this.style.color='var(--accent)'" onmouseout="this.style.color='inherit'">
                            ${w.workflow_name}
                        </a>
                    </div>
